...
const generateType = () => {
  const types = _utils_informations_js__WEBPACK_IMPORTED_MODULE_0__.wayPointTypes;
  const randomIndex = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, types.length - 1);
  return types[randomIndex];
};

const generateDestination = () => {
  const dest = _utils_informations_js__WEBPACK_IMPORTED_MODULE_0__.destinations;
  const randomIndex = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, dest.length - 1);
...
const generateDescription = () => {
  const description = _utils_informations_js__WEBPACK_IMPORTED_MODULE_0__.descriptions;
  const randomIndex = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, description.length - 1);
  return description[randomIndex];
};

const generateCost = () => (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(1, 100) * 10;

const generateOffers = () => {
  const offers = [{
    name: 'Add luggage',
    price: 30,
    isChosen: Boolean((0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 1)),
    type: 'luggage'
  }, {
...
const generatePoint = () => {
  ...
  return {
    ...
    images: (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.generateImages)(),
    cost: generateCost(),
    offers: generateOffers(),
    isArchive: Boolean((0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 1)),
...
/* harmony export */ });
/* harmony import */ var _view_site_edit_new_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/site-edit-new-point */ "./src/view/site-edit-new-point.js");
...
class PointPresenter {
  constructor(pointContainer, changeData, changeMode) {
    ...
    _defineProperty(this, "init", wayPoint => {
      ...
      _classPrivateFieldSet(this, _editPointComponent, new _view_site_edit_new_point__WEBPACK_IMPORTED_MODULE_0__["default"](wayPoint));
...
const generateBeginEndDates = () => {
  const maxGap = 10;
  const startDate = dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add((0,_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(-maxGap, maxGap), 'day').add((0,_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(-maxGap, maxGap), 'hour').add((0,_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(-maxGap, maxGap), 'minute');
  const endDate = startDate.clone().add((0,_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 14), 'day').add((0,_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 59), 'hour').add((0,_common__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 59), 'minute');
  return {
...
const destinations = () => ['Podgorica', 'Moscow', 'New York', 'Bratislava', 'Oslo', 'Ottawa', 'Prague'];
...
/***/ "./src/view/site-edit-new-point.js":
/*!*****************************************!*\
  !*** ./src/view/site-edit-new-point.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const createEditNewPoint = point => {
  ...
  const startDateRend = (0,_utils_functionsWithDayjs_js__WEBPACK_IMPORTED_MODULE_1__.dateRend)(startDate, 'D MMMM YYYY');
  const endDateRend = (0,_utils_functionsWithDayjs_js__WEBPACK_IMPORTED_MODULE_1__.dateRend)(endDate, 'D MMMM YYYY');
...
class EditNewPoint extends _Abstract_view_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(point) {
    super();
  ...
  get template() {
    return createEditNewPoint(_classPrivateFieldGet(this, _point));
  }
