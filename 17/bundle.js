...
/* harmony import */ var _utils_functionsWithDayjs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/functionsWithDayjs.js */ "./src/utils/functionsWithDayjs.js");
/* harmony import */ var _utils_informations_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/informations.js */ "./src/utils/informations.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const arrayTypes = [];
const listTypes = (0,_utils_informations_js__WEBPACK_IMPORTED_MODULE_4__.wayPointTypes)();
...
const adaptToClient = point => {
  const adaptedPoint = {
    ...
    time: (0,_utils_functionsWithDayjs_js__WEBPACK_IMPORTED_MODULE_3__.countDuration)(point.date_from, point.date_to),
    isDisabled: false,
    isDeleting: false,
    isSaving: false
  };
  ...
  constructor(apiService) {
    ...
    _defineProperty(this, "init", async () => {
      try {
        ...
        (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_2__.generateCities)(cities);
        const points = await _classPrivateFieldGet(this, _apiService).points;

        _classPrivateFieldSet(this, _points, points.map(point => adaptToClient(point)));

        (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_2__.createNewEvent)();
      } catch (err) {
...
var _replaceEditPointToPoint = /*#__PURE__*/new WeakMap();

var _replacePointToEditPoint = /*#__PURE__*/new WeakMap();
  ...
  constructor(pointContainer, changeData, changeMode) {
    ...
    _defineProperty(this, "init", wayPoint => {
      ...
      if (_classPrivateFieldGet(this, _mode) === Mode.EDITING) {
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_2__.replace)(_classPrivateFieldGet(this, _itemTemplateComponent), prevEditComponent);
      }
    ...
    _defineProperty(this, "resetView", () => {
      if (_classPrivateFieldGet(this, _mode) !== Mode.DEFAULT) {
        _classPrivateFieldGet(this, _replaceEditPointToPoint).call(this);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _replaceEditPointToPoint, {
      writable: true,
      value: () => {
    ...
    _classPrivateFieldInitSpec(this, _replacePointToEditPoint, {
      writable: true,
      value: () => {
    ...
    _defineProperty(this, "setViewState", state => {
      ...
      const resetFormState = () => {
        _classPrivateFieldGet(this, _editPointComponent).updateData({
          isDisabled: false,
          isSaving: false,
          isDeleting: false
        });
      ...
      switch (state) {
        ...
        case State.ABORTING:
          _classPrivateFieldGet(this, _itemTemplateComponent).shake(resetFormState);

          _classPrivateFieldGet(this, _editPointComponent).shake(resetFormState);
...
/* harmony import */ var _view_site_trip_info_view__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../view/site-trip-info-view */ "./src/view/site-trip-info-view.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _infoTrip = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(tripContainer, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_informations__WEBPACK_IMPORTED_MODULE_4__.SortType.DAY.text
    });

    _classPrivateFieldInitSpec(this, _filterType, {
      writable: true,
      value: _const__WEBPACK_IMPORTED_MODULE_5__.FilterType.EVERYTHING
    });
    ...
    _classPrivateFieldInitSpec(this, _infoTrip, {
      writable: true,
      value: null
    });
    ...
    _defineProperty(this, "destroy", () => {
      ...
      (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _listPointComponent));
    ...
    _classPrivateFieldInitSpec(this, _handleModelEvent, {
      ...
      value: (updateType, data) => {
        switch (updateType) {
          ...
          case _const__WEBPACK_IMPORTED_MODULE_5__.UpdateType.INIT:
            _classPrivateFieldSet(this, _isLoading, false);

            (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _loadingComponent));
    ...
    _classPrivateFieldInitSpec(this, _renderPointList, {
      writable: true,
      value: () => {
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _listPointComponent), _utils_render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _defineProperty(this, "createPoint", () => {
      ...
      _classPrivateFieldSet(this, _currentSortType, _utils_informations__WEBPACK_IMPORTED_MODULE_4__.SortType.DAY.text);

      _classPrivateFieldGet(this, _filterModel).setFilter(_const__WEBPACK_IMPORTED_MODULE_5__.UpdateType.MAJOR, _const__WEBPACK_IMPORTED_MODULE_5__.FilterType.EVERYTHING);

      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_9__.clearStatistics)(); //newEvent.type.currentType.selectedOffer = [];

      _classPrivateFieldGet(this, _pointNewPresenter).init(_utils_common__WEBPACK_IMPORTED_MODULE_11__.newEvent);
    });

    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_site_trip_sort__WEBPACK_IMPORTED_MODULE_7__["default"](_classPrivateFieldGet(this, _currentSortType)));

        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _sortComponent), _utils_render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
    ...
    _classPrivateFieldInitSpec(this, _renderLoading, {
      writable: true,
      value: () => {
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _loadingComponent), _utils_render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.AFTERBEGIN);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderNoPoint, {
      ...
      value: () => {
        ...
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _noComponent), _utils_render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
    ...
    _classPrivateFieldInitSpec(this, _clearPointList, {
      ...
      value: ({
        ...
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _sortComponent));
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _noComponent));
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _loadingComponent));
        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _infoTrip));
    ...
    _defineProperty(this, "renderInfoTrip", () => {
      if (this.points.length > 0) {
        _classPrivateFieldSet(this, _infoTrip, new _view_site_trip_info_view__WEBPACK_IMPORTED_MODULE_12__["default"](this.points));

        (0,_utils_render__WEBPACK_IMPORTED_MODULE_3__.render)(tripMainContainer, _classPrivateFieldGet(this, _infoTrip), _utils_render__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.AFTERBEGIN);
      }
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "typesList": () => (/* binding */ typesList),
...
/* harmony export */   "arrayCities": () => (/* binding */ arrayCities),
...
/* harmony import */ var _informations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./informations */ "./src/utils/informations.js");
/* harmony import */ var _functionsWithDayjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functionsWithDayjs */ "./src/utils/functionsWithDayjs.js");
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../const */ "./src/const.js");
...
const createNewEvent = () => {
  newEvent = {
    ...
    date: {
      ...
      end: dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(1, 'hour')
    },
    startPrice: 0,
    price: null,
    type: {
    ...
    time: (0,_functionsWithDayjs__WEBPACK_IMPORTED_MODULE_2__.countDuration)(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(), dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(1, 'hour')),
    isDisabled: false,
    isDeleting: false,
    isSaving: false
  };
...
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_3__.FilterType.EVERYTHING]: events => events,
  [_const__WEBPACK_IMPORTED_MODULE_3__.FilterType.FUTURE]: events => events.filter(event => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(event.date.dataBeginEvent))),
  [_const__WEBPACK_IMPORTED_MODULE_3__.FilterType.PAST]: events => events.filter(event => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(event.date.dataBeginEvent)))
};
...
const createNoTaskTemplate = () => `<p class="trip-events__msg">
      Loading...
  </p>`;
...
class EditNewPoint extends _Smart_view__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(_point) {
    super();
...
/***/ "./src/view/site-trip-info-view.js":
/*!*****************************************!*\
  !*** ./src/view/site-trip-info-view.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PointsInfoView)
/* harmony export */ });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Abstract_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Abstract-view.js */ "./src/view/Abstract-view.js");
...
class PointsInfoView extends _Abstract_view_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  get template() {
    return createTripInfo(_classPrivateFieldGet(this, _points));
  }
...
class TripTabsTemplate extends _Abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    ...
    _defineProperty(this, "setMenuClickHandler", callback => {
      ...
      tripTabs.addEventListener('click', _classPrivateFieldGet(this, _menuClickHandler));
    });
...
var _moneyChart = /*#__PURE__*/new WeakMap();

var _typeChart = /*#__PURE__*/new WeakMap();

var _timeChart = /*#__PURE__*/new WeakMap();

var _setCharts = /*#__PURE__*/new WeakMap();

class StatisticsView extends _Smart_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();

    _classPrivateFieldInitSpec(this, _moneyChart, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _typeChart, {
      writable: true,
      value: null
    });

    _classPrivateFieldInitSpec(this, _timeChart, {
      writable: true,
      value: null
    });

    _defineProperty(this, "restoreHandlers", () => {
      _classPrivateFieldGet(this, _setCharts).call(this);
    });
    ...
    _classPrivateFieldInitSpec(this, _setCharts, {
      ...
      value: () => {
        ...
        _classPrivateFieldSet(this, _moneyChart, changeMoneyChart(moneyCtx));

        _classPrivateFieldSet(this, _typeChart, changeTypeChart(typeCtx));

        _classPrivateFieldSet(this, _timeChart, changeTimeChart(timeCtx));
      }
    });
...
/* harmony import */ var _view_site_trip_tabs_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/site-trip-tabs.js */ "./src/view/site-trip-tabs.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _view_statistics_view_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/statistics-view.js */ "./src/view/statistics-view.js");
/* harmony import */ var _utils_statistics_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/statistics.js */ "./src/utils/statistics.js");
/* harmony import */ var _api_service_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./api-service.js */ "./src/api-service.js");
...
const pointsModel = new _model_points_model_js__WEBPACK_IMPORTED_MODULE_1__["default"](new _api_service_js__WEBPACK_IMPORTED_MODULE_9__["default"](END_POINT, AUTHORIZATION));
const filterModel = new _model_filter_model_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_0__["default"](tripEventsElement, pointsModel, filterModel);
const filterPresenter = new _presenter_filter_presenter_js__WEBPACK_IMPORTED_MODULE_3__["default"](tripControlsFiltersElement, filterModel, pointsModel);
tripPresenter.init();
let statsView = null;

const handleSiteMenuClick = menuItem => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_4__.MenuItem.POINTS:
      tripEventsElement.classList.add('trip-events');
      filterPresenter.destroy();
      tripPresenter.destroy();
      filterPresenter.init(pointsModel.points);
      tripPresenter.init();
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.remove)(statsView);
      statsView = null;
      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_8__.clearStatistics)();
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_4__.MenuItem.STATISTICS:
      tripEventsElement.classList.remove('trip-events');
      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_8__.counting)(pointsModel.points);
      statsView = new _view_statistics_view_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(siteMainElement, statsView, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__.RenderPosition.BEFOREEND);
      filterPresenter.destroy();
      tripPresenter.destroy();
...
pointsModel.init().finally(() => {
  filterPresenter.init(pointsModel.points);
  (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(tripControlsNavigationElement, siteMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__.RenderPosition.BEFOREEND);
