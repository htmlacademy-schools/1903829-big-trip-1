...
/* harmony import */ var _event_new_presenter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./event-new-presenter */ "./src/presenter/event-new-presenter.js");
/* harmony import */ var _view_site_trip_sort__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../view/site-trip-sort */ "./src/view/site-trip-sort.js");
/* harmony import */ var _utils_filter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/filter */ "./src/utils/filter.js");
/* harmony import */ var _utils_statistics_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/statistics.js */ "./src/utils/statistics.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class TripPresenter {
  constructor(tripContainer, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _const__WEBPACK_IMPORTED_MODULE_5__.UserAction.UPDATE_EVENT:
            _classPrivateFieldGet(this, _pointsModel).updateEvent(updateType, update);

            break;

          case _const__WEBPACK_IMPORTED_MODULE_5__.UserAction.ADD_EVENT:
            _classPrivateFieldGet(this, _pointsModel).addEvent(updateType, update);

            break;

          case _const__WEBPACK_IMPORTED_MODULE_5__.UserAction.DELETE_EVENT:
    ...
    _defineProperty(this, "createPoint", () => {
      const point = (0,_mock_point__WEBPACK_IMPORTED_MODULE_6__.generatePoint)();
      ...
      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_10__.clearStatistics)();
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_site_trip_sort__WEBPACK_IMPORTED_MODULE_8__["default"](_classPrivateFieldGet(this, _currentSortType)));
    ...
    _classPrivateFieldSet(this, _pointNewPresenter, new _event_new_presenter__WEBPACK_IMPORTED_MODULE_7__["default"](_classPrivateFieldGet(this, _listPointComponent), _classPrivateFieldGet(this, _handleViewAction)));
  }
  ...
  get points() {
    ...
    const filtered = _utils_filter__WEBPACK_IMPORTED_MODULE_9__.filter[_classPrivateFieldGet(this, _filterType)](points);
...
/* harmony import */ var _view_site_trip_tabs_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/site-trip-tabs.js */ "./src/view/site-trip-tabs.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _view_statistics_view_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view/statistics-view.js */ "./src/view/statistics-view.js");
...
const siteMenuComponent = new _view_site_trip_tabs_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
(0,_utils_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(tripControlsNavigationElement, siteMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_7__.RenderPosition.BEFOREEND);
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_1__["default"](tripEventsElement, pointsModel, filterModel);
...
const handleTaskNewFormClose = () => {
  siteMenuComponent.element.querySelector(`[value=${_const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.POINTS}]`).disabled = false;
  siteMenuComponent.element.querySelector(`[value=${_const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.STATISTICS}]`).disabled = false;
  siteMenuComponent.setMenuItem(_const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.TASKS);
};

const handleSiteMenuClick = menuItem => {
  switch (menuItem) {
    case _const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.ADD_NEW_POINT:
      // Скрыть статистику
      // Показать фильтры
      // Показать доску
      tripPresenter.createTask(handleTaskNewFormClose);
      siteMenuComponent.element.querySelector(`[value=${_const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.POINTS}]`).disabled = true;
      siteMenuComponent.element.querySelector(`[value=${_const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.STATISTICS}]`).disabled = true;
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.POINTS:
      filterPresenter.init();
      tripPresenter.init();
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_7__.remove)(statsView);
      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_9__.clearStatistics)();
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_5__.MenuItem.STATISTICS:
      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_9__.counting)(pointsModel.points);
      statsView = new _view_statistics_view_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_7__.render)(siteMainElement, statsView, _utils_render_js__WEBPACK_IMPORTED_MODULE_7__.RenderPosition.BEFOREEND);
