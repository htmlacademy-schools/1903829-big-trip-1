...
/* harmony import */ var _view_site_trip_info_view__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../view/site-trip-info-view */ "./src/view/site-trip-info-view.js");
/* harmony import */ var _utils_adapt__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/adapt */ "./src/utils/adapt.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class TripPresenter {
  constructor(tripContainer, pointsModel, filterModel) {
    ...
    _defineProperty(this, "createPoint", () => {
      ...
      (0,_utils_statistics_js__WEBPACK_IMPORTED_MODULE_9__.clearStatistics)();
      _utils_adapt__WEBPACK_IMPORTED_MODULE_12__.newEvent.type.currentType.selectedOffers = [];

      _classPrivateFieldGet(this, _pointNewPresenter).init(_utils_adapt__WEBPACK_IMPORTED_MODULE_12__.newEvent);
    });
...
const adaptToClient = point => {
  const adaptedPoint = {
    ...
    time: (0,_utils_functionsWithDayjs_js__WEBPACK_IMPORTED_MODULE_0__.countDuration)(point.date_from, point.date_to),
    isDisabled: false,
    isDeleting: false,
    isSaving: false
  };
...
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING]: events => events,
  [_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE]: events => events.filter(event => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(event.date.start))),
  [_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST]: events => events.filter(event => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(event.date.start)))
};
...
const createEditPoint = (point = {}) => {
  ...
  type.arrayType.forEach(element => {
    if (element.title === type.currentType.title) {
      type.currentType = { ...element,
        selectedOffers: type.currentType.selectedOffers ? type.currentType.selectedOffers : []
      };
    }
  });
  type.currentType.allOffer.forEach(offer => {
    ...
    const offerCurrent = (0,_utils_common__WEBPACK_IMPORTED_MODULE_4__.createOffer)(offer, checked);
    offers += offerCurrent;
  });
  let flag = false;
...
/* harmony import */ var _utils_functionsWithDayjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/functionsWithDayjs */ "./src/utils/functionsWithDayjs.js");
function _classPrivateFieldInitSpec(obj, privateMap, value) { _checkPrivateRedeclaration(obj, privateMap); privateMap.set(obj, value); }
...
const createTripInfo = points => {
  points.sort(_utils_informations_js__WEBPACK_IMPORTED_MODULE_1__.sortDate);
  const cities = points.map(point => point.city.currentCity.titleCity);
  let allPrice = null;
  points.forEach(point => {
    allPrice += Number(point.startPrice);
  });
  const dateBegin = (0,_utils_functionsWithDayjs__WEBPACK_IMPORTED_MODULE_2__.dateRend)(points[0].date.start, 'MMM D');
  const dateEnd = (0,_utils_functionsWithDayjs__WEBPACK_IMPORTED_MODULE_2__.dateRend)(points[points.length - 1].date.end, 'MMM DD');
  let tripTitles = '';
...
class PointsInfoView extends _Abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(points) {
    super();
